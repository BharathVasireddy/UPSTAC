...
class LabRequestControllerTest {
    ...
    public void calling_assignForLabTest_with_valid_test_request_id_should_update_the_request_status(){
        ...
        sampletest=labRequestController.assignForLabTest(testRequest.requestId);
        assertThat(testRequest.requestId,equalTo(sampletest.requestId));
        assertThat(sampletest.getStatus(),equalTo("INITIATED"));
        assertNotNull(sampletest.getLabResult());
