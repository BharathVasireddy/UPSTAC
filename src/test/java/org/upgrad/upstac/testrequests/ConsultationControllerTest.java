...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status(){
        ...
        TestRequest sampletest=new TestRequest();
        sampletest=consultationController.assignForConsultation(testRequest.requestId);
        //System.out.println(testRequest.requestId+"  "+sampletest.requestId+"  "+sampletest.getStatus()+"  "+sampletest.getConsultation());
        assertThat(testRequest.requestId,equalTo(sampletest.requestId));
        assertThat(sampletest.getStatus(),equalTo("DIAGNOSIS_IN_PROCESS"));
        assertNotNull(sampletest.getConsultation());
    ...
    public void calling_updateConsultation_with_valid_test_request_id_should_update_the_request_status_and_update_consultation_details(){
        ...
        sampletest=consultationController.updateConsultation(testRequest.requestId, ccr);
        assertThat(testRequest.requestId,equalTo(sampletest.requestId));
        assertThat(sampletest.getStatus(),equalTo("COMPLETED"));
        //assertThat(testRequest.getSuggestion(),equalTo(sampletest.getSuggestion()));
    }
